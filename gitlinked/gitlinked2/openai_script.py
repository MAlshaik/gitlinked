...
import os
import argparse
from recommendation_system.main import get_repositories_for_user_by_content
from recommendation_system.main import get_network_recommendations_for_item

def searchGPT(prompt):
    dotenv.load_dotenv()
    ...
    data = get_repositories_for_user_by_content(args.id)
    return data
